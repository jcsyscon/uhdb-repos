...
public class ApiUhdbController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "uhdbNo", value = "무인택배함번호(아파트아이디-아파트위치)", required = true, dataType = "string", paramType = "path", defaultValue = "")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "uhdbNo", value = "무인택배함번호(아파트아이디-아파트위치)", required = true, dataType = "string", paramType = "query", defaultValue = ""), @ApiImplicitParam(name = "boxNo", value = "무인택배함 보관함번호", required = true, dataType = "string", paramType = "query", defaultValue = ""), @ApiImplicitParam(name = "password", value = "비밀번호", required = true, dataType = "string", paramType = "query", defaultValue = ""), @ApiImplicitParam(name = "tbcode", value = "tb코드", required = true, dataType = "string", paramType = "query", defaultValue = "")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "uhdbNo", value = "무인택배함번호(아파트아이디-아파트위치)", required = true, dataType = "string", paramType = "query", defaultValue = ""), @ApiImplicitParam(name = "boxNo", value = "무인택배함 보관함번호", required = true, dataType = "string", paramType = "query", defaultValue = "")})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "gubun", value = "구분(past/now)", required = true, dataType = "string", paramType = "path", defaultValue = ""), @ApiImplicitParam(name = "userSeq", value = "회원일련번호", required = true, dataType = "int", paramType = "path", defaultValue = "")})
    ...
    public ApiResponse<?> searchUhdbLogList(@PathVariable("gubun") String gubun, @PathVariable("userSeq") Integer userSeq, MobilePagingHelper mobilePagingHelper, UhdbDto param) throws CommonApiException {
        try {
            ...
            List<UhdbLogVo> uhdbLogList = this.uhdbService.findUhdbLogList4MobileV2(param);
